...
# Deinition of ENOID kinetics model
class ENOID_KineticsModel():
    def __init__(self, name="ENOID", body=None, 
        L_LEG_J1=None, L_LEG_J2=None, L_LEG_J3=None, L_LEG_J4=None, L_LEG_J5=None,
        R_LEG_J1=None, R_LEG_J2=None, R_LEG_J3=None, R_LEG_J4=None, R_LEG_J5=None): 

        self.name = name
        self.mass = 0
        self.waist_width = 38.5 / 1000 # distance between left hip and right hip
        self.thigh_length = 78 / 1000
        self.shank_length = 97 / 1000
        ...
        self.ID = {'NONE': 0, 'BODY': 1, 'L_LEG_J1': 2, 'L_LEG_J2': 3, 'L_LEG_J3': 4, 'L_LEG_J4': 5, 'L_LEG_J5': 6,'R_LEG_J1': 7, 'R_LEG_J2': 8, 'R_LEG_J3': 9, 'R_LEG_J4': 10, 'R_LEG_J5': 11}
        ...
        self.link_group = {
            ...
            self.ID.get('L_LEG_J5'):self.L_LEG_J5,
            ...
            self.ID.get('R_LEG_J5'):self.R_LEG_J5}
    ...
    def showPosition(self):
        ...
        print('L_LEG_J5, Pos= ', self.L_LEG_J5.p)
        ...
        print('R_LEG_J5, Pos= ', self.R_LEG_J5.p)
    
    def setJointAngle(self, q):

        # pastikan sama master
        self.L_LEG_J1.q = q[0]
        self.L_LEG_J2.q = q[1]
        self.L_LEG_J3.q = q[2]
        self.L_LEG_J4.q = q[3]
...
# Create the ENOID's kinematics model
def createENOIDKinematicsModel():
    r = ENOID_KineticsModel()
    # ===============body================
    a = np.matrix((0, 0, 0)).T
    b = np.matrix((0, 0, 0)).T
    ...
    # ===============left leg================
    a = np.matrix((1, 0, 0)).T
    b = np.matrix((0, r.waist_width, 0)).T
    p = np.matrix((0.0, 0.0, 0.0)).T
    R = np.matrix(((1, 0, 0), (0, 1, 0), (0, 0, 1)))
    m = 0
    c = np.matrix((0, 0, 0)).T
    ...
    b = np.matrix((-r.ANKLE_FOOT, 0, 0)).T  # pastikan sama master
    p = np.matrix((0.0, 0.0, 0.0)).T
    R = np.matrix(((1, 0, 0), (0, 1, 0), (0, 0, 1)))
    m = 0
    c = np.matrix((0, 0, -0.25)).T
    ...
    b = np.matrix((-r.ANKLE_FOOT, 0, 0)).T  # gatau
    p = np.matrix((0.0, 0.0, 0.0)).T
    R = np.matrix(((1, 0, 0), (0, 1, 0), (0, 0, 1)))
    m = 0
    c = np.matrix((0, 0, -0.25)).T
    ...
    robot_model = ENOID_KineticsModel(body=link_body, 
        L_LEG_J1 = link_L_LEG_J1, L_LEG_J2 = link_L_LEG_J2, L_LEG_J3 = link_L_LEG_J3, L_LEG_J4 = link_L_LEG_J4, L_LEG_J5 = link_L_LEG_J5, 
        R_LEG_J1 = link_R_LEG_J1, R_LEG_J2 = link_R_LEG_J2, R_LEG_J3 = link_R_LEG_J3, R_LEG_J4 = link_R_LEG_J4, R_LEG_J5 = link_R_LEG_J5)
